...
class TextDrawer {
   public:
    ...
    void DrawRoom(std::string host_nick, std::string room_name,
                  GameState state) {
        Table menu;
        menu.format()
            .border_color(Color::white)
    ...
    void DrawCreateRoom() {
        Table menu;
        menu.add_row(
            Row_t{"Please enter room name, your color (black / white): "});
        menu[0]
            .format()
            .font_align(FontAlign::center)
            .font_style({FontStyle::underline, FontStyle::italic})
    ...
    void DrawGetAllRooms(std::map<std::string, RoomData> rooms_data) {
        ...
        menu[2]
            ...
            .font_color(Color::magenta);
        Table highlights;
        highlights.add_row(Row_t{"1 Get Rooms", "2 Create Room", "3 Enter Room",
                                 "4 Exit Game"});
    ...
    void DrawBasicMenu() {
        ...
        menu.add_row(
            Row_t{"Welcome to Basic Menu, here you can choose action"});
        menu[0]
            .format()
            .font_align(FontAlign::center)
            .font_color(Color::magenta);
